...
const countryListurl = "https://api.currencyapi.com/v3/currencies?apikey=cur_live_sGXjfx1tGzZRGVtZ8bZM3c4rdeelCGgZGYjWYIY1";
  let mystring = "";
...
//   console.log(rjson);
    ...
    //  saving the list of countries supported by currencyapi
    const countryList = {
        "data": {
          "AED": {
            "symbol": "AED",
      ...
      // temporarily storing the result returned from API - do not want to exhaust my API limit.
...
const currencyvalues = 
{
  ...
  for(let key of Object.keys(currencyvalues.data)) {
    console.log(countryList.data[key]["name"]);
  }
